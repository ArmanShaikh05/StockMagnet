...
import { ArrowRight, DollarSign, LineChart, Sparkle, SparkleIcon } from "lucide-react";
    ...
    <section className="pb-10 sm:px-6">
      <div className="">
        ...
        <div className="p-16 bg-main/80 rounded-2xl max-w-7xl mx-auto">
            <Image src={"/hero_image.png"} alt="heroImage" width={1300} height={500} className="rounded-2xl overflow-hidden" />
        </div>
      </div>
    </section>
  );
