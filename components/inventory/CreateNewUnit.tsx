...
const CreateNewUnit = ({ unitsData }: { unitsData: Units[] }) => {
  const router = useRouter();

  const [showCreateNewUnitDialog, setShowCreateNewUnitDialog] =
    useState<boolean>(false);
  ...
  return (
    <>
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Manage your Units</AlertDialogTitle>
            <AlertDialogDescription>
              Here you can view all your units along with number of products and
              can remove units with none.
            </AlertDialogDescription>
          </AlertDialogHeader>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={() => setShowCreateNewUnitDialog(true)}>
              Add New
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      ...
      {showCreateNewUnitDialog && (
        <AlertDialog
          open={showCreateNewUnitDialog}
          onOpenChange={setShowCreateNewUnitDialog}
        >
          <AlertDialogContent>
            <AlertDialogHeader>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction asChild>
                <Button disabled={loading} onClick={(e) => createUnit(e)}>
                  {loading ? (
                    <div className="flex w-full items-center justify-center gap-2">
                      <Loader2 className="w-4 h-4 animate-spin" />
